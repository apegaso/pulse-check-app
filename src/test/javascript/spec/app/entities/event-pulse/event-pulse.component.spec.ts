...
import { EventPulseComponent } from 'app/entities/event-pulse/event-pulse.component';
...
describe('Component Tests', () => {
    describe('EventPulse Management Component', () => {
        let comp: EventPulseComponent;
        let fixture: ComponentFixture<EventPulseComponent>;
        let service: EventPulseService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PulseCheckAppTestModule],
                declarations: [EventPulseComponent],
                providers: [
                    {
                ...
                .overrideTemplate(EventPulseComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(EventPulseComponent);
