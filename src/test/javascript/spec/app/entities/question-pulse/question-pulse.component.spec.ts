...
import { QuestionPulseComponent } from 'app/entities/question-pulse/question-pulse.component';
...
describe('Component Tests', () => {
    describe('QuestionPulse Management Component', () => {
        let comp: QuestionPulseComponent;
        let fixture: ComponentFixture<QuestionPulseComponent>;
        let service: QuestionPulseService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PulseCheckAppTestModule],
                declarations: [QuestionPulseComponent],
                providers: [
                    {
                ...
                .overrideTemplate(QuestionPulseComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(QuestionPulseComponent);
