...
import { ParticipantPulseComponent } from 'app/entities/participant-pulse/participant-pulse.component';
...
describe('Component Tests', () => {
    describe('ParticipantPulse Management Component', () => {
        let comp: ParticipantPulseComponent;
        let fixture: ComponentFixture<ParticipantPulseComponent>;
        let service: ParticipantPulseService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PulseCheckAppTestModule],
                declarations: [ParticipantPulseComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ParticipantPulseComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ParticipantPulseComponent);
