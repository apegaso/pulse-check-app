...
import { CategoryPulseComponent } from 'app/entities/category-pulse/category-pulse.component';
...
describe('Component Tests', () => {
    describe('CategoryPulse Management Component', () => {
        let comp: CategoryPulseComponent;
        let fixture: ComponentFixture<CategoryPulseComponent>;
        let service: CategoryPulseService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PulseCheckAppTestModule],
                declarations: [CategoryPulseComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CategoryPulseComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CategoryPulseComponent);
