...
import { UserExtPulseComponent } from 'app/entities/user-ext-pulse/user-ext-pulse.component';
...
describe('Component Tests', () => {
    describe('UserExtPulse Management Component', () => {
        let comp: UserExtPulseComponent;
        let fixture: ComponentFixture<UserExtPulseComponent>;
        let service: UserExtPulseService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [PulseCheckAppTestModule],
                declarations: [UserExtPulseComponent],
                providers: [
                    {
                ...
                .overrideTemplate(UserExtPulseComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(UserExtPulseComponent);
