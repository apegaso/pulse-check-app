...
public interface QuestionnaireRepository extends JpaRepository<Questionnaire, Long> {
    ...
    Optional<Questionnaire> findByParticipantIdAndEventId(@Param("userid")Long userid, @Param("eventid")Long eventid);
    ...
    @Query("select questionnaire from Questionnaire questionnaire left join fetch questionnaire.event event join fetch questionnaire.participant participant where participant.id =:userid")
	List<Questionnaire> findAllByParticipantId(@Param("userid") Long userid);
